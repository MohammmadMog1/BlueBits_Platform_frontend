          ...
          >
            <motion.div
              ...
              className={`w-full max-w-sm rounded-3xl p-8 text-center shadow-2xl ${
                isDark
                  ? "border border-white/10 bg-[#1a1b1e]"
                  : "border border-gray-200 bg-white"
              }`}
            >
              <div
                className={`mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl ${accentIconClass(
                  isDark,
                  "rose",
                )}`}
              >
              ...
              <p
                className={`mb-6 text-sm font-black ${isDark ? "text-[#7fb5e4]" : "text-[#404293]"}`}
              >
