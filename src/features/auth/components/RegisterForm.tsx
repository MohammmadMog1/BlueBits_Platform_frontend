				...
				<div>
					<div className="relative">
						...
						<input
							...
							className={`w-full bg-gray-50 border ${errors.name ? 'border-red-500/50' : 'border-gray-200 focus:ring-[#33529F]'} rounded-2xl py-4 pl-14 pr-5 text-[#202121] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all`}
						/>
					</div>
				...
				<div>
					<div className="relative">
						...
						<input
							...
							className={`w-full bg-gray-50 border ${errors.email ? 'border-red-500/50' : 'border-gray-200 focus:ring-[#33529F]'} rounded-2xl py-4 pl-14 pr-5 text-[#202121] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all`}
						/>
					</div>
				...
				<div>
					<div className="relative">
						...
						<input
							...
							className={`w-full bg-gray-50 border ${errors.password ? 'border-red-500/50' : 'border-gray-200 focus:ring-[#33529F]'} rounded-2xl py-4 pl-14 pr-14 text-[#202121] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all`}
						/>
						<button
							type="button"
				...
				<div>
					<div className="relative">
						...
						<input
							...
							className={`w-full bg-gray-50 border ${errors.confirmPassword ? 'border-red-500/50' : 'border-gray-200 focus:ring-[#33529F]'} rounded-2xl py-4 pl-14 pr-5 text-[#202121] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all`}
						/>
					</div>
