    ...
    <div className="flex flex-col gap-6">
      ...
      {toast ? (
        <motion.div
          ...
          exit={{ opacity: 0, y: 16 }}
          className={`fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom,0))] left-1/2 -translate-x-1/2 z-500 rounded-2xl px-5 py-3.5 text-sm font-semibold shadow-xl lg:bottom-6 ${
            toast.type === "success"
