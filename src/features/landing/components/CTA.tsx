  ...
  return (
    <section className="relative py-20 sm:py-32 overflow-hidden">
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #0f1015 0%, #404293 50%, #2376BB 100%)",
        }}
      />
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <HexGrid
          className="absolute -right-10 top-0 w-[400px] sm:w-[600px] h-full"
          opacity={0.08}
        />
        <HexGrid
          className="absolute -left-10 bottom-0 w-[280px] sm:w-[400px] h-full"
          opacity={0.05}
        />
      </div>
