  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm font-black">استبيان جدول الامتحانات مفتوح</p>
        <p className="mt-0.5 text-xs font-semibold opacity-80">
          {getRefName(survey.form.semesterId, "الفصل الحالي")} ·{" "}
          {survey.form.academicYear} — رأيك يحدّد ترتيب الامتحانات
        </p>
      </div>
      <Link
        to="/user/survey"
