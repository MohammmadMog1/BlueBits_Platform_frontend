...
export function CommentItem({ comment, isOwner, isDark, onSave, onDelete }: CommentItemProps) {
  ...
  return (
    <div className="flex items-start gap-2.5">
      <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[#404293] to-[#2376BB] text-[11px] font-bold text-white">
        {avatarUrl ? (
