...
export default function GlobalLoader() {
  ...
  return (
    <div className="pointer-events-none fixed right-4 top-4 z-[60] flex items-center gap-2 rounded-full border border-white/10 bg-slate-900/80 px-3 py-2 text-sm text-slate-200 shadow-lg shadow-black/20 backdrop-blur-md">
