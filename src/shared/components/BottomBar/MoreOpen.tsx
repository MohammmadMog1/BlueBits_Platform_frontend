...
export default function MoreOpenIcon({ moreOpen, setMoreOpen }: MoreOpenIconProps) {
    const location = useLocation(); // تعريف الـ location لتجنب كراش التطبيق

    const handleNav = (path: string) => {
        // يمكنك إما ترك الـ navigate هنا أو إدارتها بالكامل من الأب،
        // ولكن للتصليح السريع سنقوم بإغلاق القائمة عند الضغط
        setMoreOpen(false);
    };
